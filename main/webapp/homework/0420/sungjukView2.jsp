<%@page import="homework.h0420.SungjukVO2"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%
	request.setCharacterEncoding("utf-8");
	SungjukVO2 vo = (SungjukVO2)request.getAttribute("vo");
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="container" align="center">
	...
	<table class="table table-hover">
		...
		<tr>
			<td colspan="2">
				<input type="button" value="돌아가기" onclick="location.href='<%=request.getContextPath()%>/homework/0420/sungjuk2.jsp';" class="btn btn-info form-control"/>
			</td>
		</tr>
	</table>
</div>
